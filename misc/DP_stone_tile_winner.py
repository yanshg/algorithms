...
# DP[i][j][0]:  First player's score with A[i:j+1]
# DP[i][j][1]:  Second player's score with A[i:j+1]

# return DP[0][n-1][0] > DP[0][n-1][1]

def check_if_first_player_win(A):
    n = len(A)
...
A = [1, 5, 233, 7]
assert check_if_first_player_win(A)